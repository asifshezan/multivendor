    ...
    <div class="col-md-8">
        <div class="card border border-primary">
            <div class="card-header bg-transparent border-primary d-flex justify-content-between">
                <h5 class="my-0 text-primary align-middle"><i class="mdi mdi-bullseye-arrow me-3"></i>Partners Information</h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($data -> partner_logo != '')
                                            <img src="{{ asset('uploads/partner/' . $data->partner_logo) }}" height="60">
                                            @else
